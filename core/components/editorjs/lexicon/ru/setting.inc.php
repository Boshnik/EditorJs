...
$_lang['area_editorjs_main'] = 'Основные';

$_lang['setting_editorjs_media_source'] = 'Источник файлов';
$_lang['setting_editorjs_image_path'] = 'Папка для загруженных картинок';
$_lang['setting_editorjs_placeholder'] = 'Placeholder';
$_lang['setting_editorjs_templates_url'] = 'Шаблоны (по умолчанию)';
